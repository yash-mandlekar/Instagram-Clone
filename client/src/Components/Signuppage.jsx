...
const Signuppage = ({ setauthenticated }) => {
    ...
    const onChangeHandler1 = (e) => {
        ...
        if (valid.email && ref2.current.value.length > 2 && ref3.current.value.length > 2 && ref4.current.value.length > 5) {
                ...
                <div className="box">
                    ...
                    <a href="https://www.facebook.com/login.php?skip_api_login=1&api_key=124024574287414&kid_directed_site=0&app_id=124024574287414&signed_next=1&next=https%3A%2F%2Fwww.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D124024574287414%26redirect_uri%3Dhttps%253A%252F%252Fwww.instagram.com%252Faccounts%252Fsignup%252F%26state%3D%257B%2522fbLoginKey%2522%253A%25221mrh52n1kfsl0i431ywulijsdx1wvir7h12jz6qo7cqiukyv5uaf%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%2522%257D%26scope%3Demail%26response_type%3Dcode%252Cgranted_scopes%26locale%3Den_US%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D367032a2-76c4-4f33-bc0b-cf57ad75f649%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.instagram.com%2Faccounts%2Fsignup%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%2522fbLoginKey%2522%253A%25221mrh52n1kfsl0i431ywulijsdx1wvir7h12jz6qo7cqiukyv5uaf%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%2522%257D%23_%3D_&display=page&locale=en_GB&pl_dbl=0">
                        <button className="fb-login-btn" type="button">
                            <div className="signupfblogo">
                                <img height="15px" src="https://imgs.search.brave.com/AX34wiiWNWK_TUaPjJj-qm13dz5_VtTsAm8yxC8VIYU/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5S/amtKWXlnSFFXc0hP/a01TeUlqdm13SGFI/YSZwaWQ9QXBp" alt="" />
                    ...
                    <form className="login-form" onSubmit={signupform}>
                        <div className="field">
                            ...
                            {valid.email ? <ion-icon className='check' name="checkmark-circle-outline"></ion-icon>
                                : attempt.email && <ion-icon className='check' name="close-circle-outline"></ion-icon>}
                        </div>
                        <div className="field">
                            <input
                                onChange={onChangeHandler1}
                            ...
                            {valid.fullname ? <ion-icon className='check' name="checkmark-circle-outline"></ion-icon>
                                : attempt.fullname && <ion-icon className='check' name="close-circle-outline"></ion-icon>}
                        </div>
                        <div className="field">
                            <input
                                onChange={onChangeHandler1}
                            ...
                            {valid.username ? <ion-icon className='check' name="checkmark-circle-outline"></ion-icon>
                                : attempt.username && <ion-icon className='check' name="close-circle-outline"></ion-icon>}
                        </div>
                        <div className="field field4">
                            ...
                            {valid.password ? <ion-icon className='check' name="checkmark-circle-outline"></ion-icon>
                                : attempt.password && <ion-icon className='check' name="close-circle-outline"></ion-icon>}
                            {input.button === "Hide" ? <div className='button' onClick={Hide}>Hide</div> :
                                <div className='button' onClick={Show}>{input.button}</div>}
                        </div>
                        <button ref={ref5} className="login-button" title="Signup">Sign up</button>
                    </form>
                    <p className="ZGwn1">By signing up, you agree to our <a href="https://help.instagram.com/581066165581870" tabIndex="0" waprocessedanchor="true">Terms</a> , <a href="https://help.instagram.com/519522125107875" tabIndex="0" waprocessedanchor="true">Data Policy</a> and <a href="/legal/cookies/" tabIndex="0">Cookies Policy</a> .</p>
                </div>
                <div className="box">
                    <p>Have an account? <Link className="signup" to="/">Log in</Link></p>
                </div>
                Get the app.
                <div className="store">
